...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<form class="edui-image-form" method="post" action="http://www.tone-tv.com/fenxiao-server/image/addImage.do?type=ajax" enctype="multipart/form-data" target="up">' +
        ...
        uploadComplete: function(r){
            ...
            // var json = {"result":"http://localhost:81/umeditor/", "errorCode":"SUCCESS"};
            ...
            var me = this;
            if(json.errorCode == 0){
                    json.errorCode = 'SUCCESS';
                
            try{
                //var json = eval('('+r+')');
                Base.callback(me.editor, me.dialog, json.result, json.errorCode);
            }catch (e){
